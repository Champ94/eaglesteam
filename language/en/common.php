...
$lang = array_merge($lang, array(
    ...
    'ADM_SETTINGS_IMAGES'                   => 'Link for banner and social images',
    'ADM_SETTINGS_BANNER_1_DESCRIPTION'     => 'Link for the first banner image shown under Eagles Projects in Notice Board',
    'ADM_SETTINGS_BANNER_2_DESCRIPTION'     => 'Link for the second banner image shown under Eagles Projects in Notice Board',
    'ADM_SETTINGS_SOCIAL_1_DESCRIPTION'     => 'Link for the first social icon shown under Eagles Projects in Notice Board',
    'ADM_SETTINGS_SOCIAL_2_DESCRIPTION'     => 'Link for the second social icon shown under Eagles Projects in Notice Board',
    'ADM_SETTINGS_SOCIAL_3_DESCRIPTION'     => 'Link for the third social icon shown under Eagles Projects in Notice Board',
    'ADM_SETTINGS_SOCIAL_4_DESCRIPTION'     => 'Link for the fourth social icon shown under Eagles Projects in Notice Board',
